          ...
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="border border-gray-200 rounded-lg p-4 mb-8">
              ...
              <p className="mt-2 text-sm text-gray-500">
                Static image for social media sharing
              </p>
            </div>
                  ...
                  <div className="max-w-md mx-auto bg-white rounded-md shadow-sm overflow-hidden">
                    <div className="p-4">
                      ...
                      <h4 className="text-base font-semibold mt-1">
                        JOÃO JUNQUEIRA | Cybersecurity Engineer & Developer
                      </h4>
                      <p className="text-sm text-gray-500 mt-1">
                        Portfolio of JOÃO JUNQUEIRA, a cybersecurity engineer
                        and developer creating secure digital experiences.
                      </p>
                    </div>
                    <img
                      src="/images/og-image.png"
                  ...
                  <div className="max-w-md mx-auto bg-white rounded-md shadow-sm overflow-hidden">
                    ...
                    <div className="p-4">
                      <h4 className="text-base font-semibold">
                        JOÃO JUNQUEIRA | Designer & Developer
                      </h4>
                      <p className="text-sm text-gray-500 mt-1">
                        Portfolio of JOÃO JUNQUEIRA, a cybersecurity engineer
                        and developer creating secure digital experiences.
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm text-gray-600">
                <li>
                  ...
                  <span className="block text-xs text-gray-500 mt-1">
                    Scrape and debug how your site appears when shared on
                    Facebook
                  </span>
                </li>
                <li>
